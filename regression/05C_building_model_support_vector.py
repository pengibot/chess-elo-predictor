...
def main():
    print("Started Building Model for Support Vector Regression...")
    ...
    model_filename = r"support_vector_model.pkl"
    ...
    print("Finished Building Model for Support Vector Regression...")
